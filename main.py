...
#         self.batch = Batch()
#
#     def setup(self, map_name: str, level: int):
...
#                 gem.center_x = random.randint(1, 13) * CELL_SIZE
#                 gem.center_y = random.randint(1, 4) * CELL_SIZE
#                 self.gemes_list.append(gem)
#         else:
#             for _ in range(self.money_num):
#                 money = arcade.Sprite(':resources:images/items/gold_1.png', 0.5)
#                 money.center_x = random.randint(1, 13) * CELL_SIZE
#                 money.center_y = random.randint(1, 4) * CELL_SIZE
...
#             self.gems_eaten = 0
#             self.setup('assets/tiled.tmx', level=2)
#
#         if self.money_num == self.moneys_eaten:
#             self.game_over = True
#
#             cam_x, cam_y = self.world_camera.position
...
#
# def main():
#     game = Tiled(SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_TITLE)
#     game.setup('assets/tiled.tmx', level=1)
#     arcade.run()
#
#
